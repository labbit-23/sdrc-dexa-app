...
import { listOsteoPatients } from '@/lib/fetch-scan.js'
              ...
              {patients.map((p, i) => (
                <tr key={p.mrn} style={{ background: i % 2 === 0 ? '#fff' : '#f8fafc' }}>
                  ...
                  <td style={{ ...td, textAlign: 'right' }}>
                    <Link href={`/bmd/report/osteo/${p.mrn}`} style={{
...
const td = { padding: '10px 12px', borderBottom: '1px solid #e5eaf0', color: '#374151' }
