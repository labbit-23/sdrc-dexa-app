...
function parseBilateral(snapshot) {
  ...
  const arms = b.left_arm && b.right_arm ? {
    left: b.left_arm, right: b.right_arm,
    lean_asym: asym(b.left_arm.lean_g, b.right_arm.lean_g),
    fat_asym:  asym(b.left_arm.fat_g,  b.right_arm.fat_g),
    dominant:  b.left_arm.lean_g > b.right_arm.lean_g ? 'left' : 'right',
  } : null

  const legs = b.left_leg && b.right_leg ? {
    left: b.left_leg, right: b.right_leg,
    lean_asym: asym(b.left_leg.lean_g, b.right_leg.lean_g),
    fat_asym:  asym(b.left_leg.fat_g,  b.right_leg.fat_g),
    dominant:  b.left_leg.lean_g > b.right_leg.lean_g ? 'left' : 'right',
  } : null
