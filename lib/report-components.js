...
export function fatLossTargets(comp, calc, gender) {
  ...
  const targets = [30, 25, 20]
    .map(pct => {
      ...
      return { pct, fatToLose, weightToLose, targetWeight }
    })
  ...
  return {
    ...
    targets,
    sarcopeniaRisk,
    preservationNote: 'These targets assume you preserve lean mass through resistance training (2–3× per week). Without strength work, you risk losing muscle along with fat.',
  }
}
