...
export function forearmSummary(left_forearm, right_forearm) {
  ...
  // Primary diagnostic: Radius 33%
  const radiusUD = left_forearm?.['Radius 33%'] || right_forearm?.['Radius 33%']

  return { rows, hasLeft, hasRight, primaryDiagnostic: radiusUD }
}
