  ...
  <div class="pb">
    ...
    ${(() => {
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:6mm;margin-bottom:4mm">
        ...
        <div>
          <div class="ptitle"><small>Why DEXA?</small>Method</div>
          <div style="font-size:9px;color:var(--muted);line-height:1.6">
            <p style="margin:0 0 1.5mm 0">DEXA separates fat, lean and bone tissue precisely — the only method that directly measures all three. Radiation dose &lt; 1 μSv.</p>
            <p style="margin:0;font-size:8.5px"><strong>Caveats:</strong> Reference: ${esc(pt.ethnicity || 'White')} population. South Asian norms unavailable. For clinical use — interpret with a clinician.</p>
          </div>
        </div>
      </div>`
    })()}
    <div style="text-align:center;font-size:8px;color:var(--muted);padding:2mm 0;border-top:1px solid var(--hairline)">
      <div style="display:inline-flex;flex-direction:column;align-items:center;gap:1mm">
        <div style="font-family:'Instrument Serif',serif;font-style:italic;color:var(--accent)">Gold standard</div>
        <div style="font-size:7.5px;letter-spacing:.1em;text-transform:uppercase">WHO endorsed</div>
      </div>
    </div>
  </div>
  <footer class="pf">
