...
function bodyFatRefCard(fatPct, gender, P) {
  ...
  // ACE Categories with proportional widths to match range sizes
  // Males: scale 0-40%, Females: scale 0-50%
  const zones = male
    ? [{ lbl: 'Athletic', range: '6–13%',   w: 17.5, c: C.greenLt, lo: 6,  hi: 13 },   // 7/40
       { lbl: 'Fit',      range: '14–17%',  w: 10,   c: C.tealLt,  lo: 14, hi: 17 },   // 4/40
       { lbl: 'Normal',   range: '18–24%',  w: 17.5, c: C.amber,   lo: 18, hi: 24 },   // 7/40
       { lbl: 'Excess',   range: '25%+',    w: 55,   c: C.red,     lo: 25, hi: 100 }]  // 15/40
    : [{ lbl: 'Athletic', range: '14–20%',  w: 14,   c: C.greenLt, lo: 14, hi: 20 },   // 7/50
       { lbl: 'Fit',      range: '21–24%',  w: 8,    c: C.tealLt,  lo: 21, hi: 24 },   // 4/50
       { lbl: 'Normal',   range: '25–31%',  w: 14,   c: C.amber,   lo: 25, hi: 31 },   // 7/50
       { lbl: 'Excess',   range: '32%+',    w: 64,   c: C.red,     lo: 32, hi: 100 }]  // 18/50
