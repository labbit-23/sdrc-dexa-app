  ...
  const fatTargetsBlock = (() => {
    ...
    const rows = targets.targets.map(({ pct, fatToLose, weightToLose, targetWeight }) => {
      return `<tr>
        ...
        <td ${s(`padding:6px 10px;font-size:11px;font-weight:700;color:${C.amber};font-family:monospace;text-align:right`)}>${fatToLose} kg</td>
        <td ${s(`padding:6px 10px;font-size:11px;font-weight:700;color:${P.text};font-family:monospace;text-align:right`)}>${weightToLose} kg</td>
        <td ${s(`padding:6px 10px;font-size:11px;font-weight:700;color:${P.text};font-family:monospace;text-align:right`)}>${targetWeight} kg</td>
      </tr>`
    }).join('')
    ...
    <div class="card" ${s('flex-shrink:0')}>
      ...
      <table ${s('width:100%;border-collapse:collapse')}>
        <thead><tr>
          ...
          <th ${s(`padding:4px 10px;font-size:9px;font-weight:700;color:${P.gray};text-align:right;border-bottom:1px solid ${P.border}`)}>Weight</th>
        </tr></thead>
        <tbody>${rows}</tbody>
      </table>
