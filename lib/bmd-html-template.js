        ...
        <div class="row" ${s('gap:14px;align-items:flex-start')}>
          <div ${s('flex:1')}>
            ...
            <div ${s(`font-size:9px;color:${P.gray};line-height:1.45`)}>
              Calories burned <strong ${s(`color:${P.text}`)}>at complete rest</strong> — organ function, circulation, thermoregulation.<br>
              From lean mass via Katch-McArdle. <strong ${s(`color:${P.text}`)}>Higher lean mass = higher RMR.</strong>
            </div>
          </div>
...
function page2(data, P, lh = false, pageNum = 2, totalPages = 5) {
  ...
  <div class="card" ${s('flex-shrink:0')}>
    ...
    <div ${s('display:flex;align-items:center;gap:12px')}>
      ...
      <div ${s('flex:1')}>
        <div ${s(`font-size:10px;color:${P.text};font-weight:600`)}>Body fat higher than ${c}% of same-age, same-sex peers &nbsp;·&nbsp; <span style="color:${centileColor}">${centileLabel}</span></div>
