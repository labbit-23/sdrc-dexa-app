...
const _labitBadge = `<div style="display:flex;flex-direction:column;align-items:center;gap:3px;flex-shrink:0;margin-left:12px"><img src="${_BASE}/labit-logo.png" height="30" style="display:block;object-fit:contain"><span style="font-size:6.5px;font-weight:700;color:#0D7377;letter-spacing:.4px">www.labit.online</span></div>`
