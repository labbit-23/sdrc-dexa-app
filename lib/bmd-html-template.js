...
<div class="page">
  ...
  <div ${s('flex:1;display:flex;gap:16px;min-height:0')}>
    ...
    <div class="col" ${s('flex:1;gap:12px;min-height:0')}>
      ...
      <div class="card" ${s('flex-shrink:0')}>
        <div class="row" ${s('gap:14px;align-items:center')}>
          <div ${s('flex-shrink:0')}>
            <div ${s(`font-size:8.5px;font-weight:700;color:${P.gray};text-transform:uppercase;letter-spacing:.5px;margin-bottom:2px`)}>Resting Metabolic Rate</div>
            <div ${s('display:flex;align-items:baseline;gap:4px')}>
            ...
            <div ${s(`font-size:8px;color:${P.gray};margin-top:2px;max-width:130px;line-height:1.5`)}>Katch-McArdle from lean mass</div>
          </div>
          <div ${s(`width:1px;background:${P.border};align-self:stretch`)}></div>
          <div ${s('flex:1;display:grid;grid-template-columns:1fr 1fr;gap:2px 10px')}>
            ${[
              ['Sedentary', 1.2],
              ['Light',     1.375],
              ['Moderate',  1.55],
