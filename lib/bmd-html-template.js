...
function header(pt, title, P, lh = false, pageNum = 0, totalPages = 0, subtitle = '') {
  ...
  const logoRow = lh ? '' : `
    <div class="page-logo-row" ${s('display:flex;justify-content:space-between;align-items:center;padding-bottom:8px;margin-bottom:8px;border-bottom:1px solid ' + P.border)}>
      <img src="https://www.sdrc.in/assets/sdrc-logo-full.png" alt="SDRC Diagnostics" ${s(`height:48px;width:auto;border-radius:4px;padding:${P === darkPal ? '2px 4px' : '0'};background:${P === darkPal ? 'rgba(255,255,255,0.92)' : 'transparent'}`)}>
