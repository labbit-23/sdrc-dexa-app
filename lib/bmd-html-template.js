...
function bodyFatRefCard(fatPct, gender, P) {
  ...
  // Males: [athletic(0-13), fitness(13-17), normal(17-24), overweight(24-29), obese(29+)]
  // Females: [athletic(0-20), fitness(20-24), normal(24-31), overweight(31-36), obese(36+)]
  const zones = male
    ? [{ lbl: 'Athletic', range: '< 13%',   w: 12, c: C.greenLt, lo: 0,  hi: 12.9 },   // 0-13
       { lbl: 'Fitness',  range: '13–17%',  w: 4.7, c: C.tealLt,  lo: 13, hi: 17 },   // 13-17
       { lbl: 'Normal',   range: '17–24%',  w: 10.5, c: C.amber,   lo: 17, hi: 24 },   // 17-24
       { lbl: 'Overweight', range: '24–29%', w: 7.5, c: C.orange, lo: 24, hi: 29 },   // 24-29
       { lbl: 'Obese',    range: '29%+',    w: 15.3, c: C.red,     lo: 29, hi: 50 }]  // 29-50
    : [{ lbl: 'Athletic', range: '< 20%',  w: 16, c: C.greenLt, lo: 0,  hi: 19.9 },   // 0-20
       { lbl: 'Fitness',  range: '20–24%', w: 5.1, c: C.tealLt,  lo: 20, hi: 24 },   // 20-24
       { lbl: 'Normal',   range: '24–31%', w: 11.4, c: C.amber,   lo: 24, hi: 31 },   // 24-31
       { lbl: 'Overweight', range: '31–36%', w: 8.2, c: C.orange, lo: 31, hi: 36 },   // 31-36
       { lbl: 'Obese',    range: '36%+',   w: 9.3, c: C.red,      lo: 36, hi: 50 }]  // 36-50
  ...
  <div class="card" ${s('flex-shrink:0')}>
    ...
    <div ${s('display:flex;justify-content:space-between;margin-top:24px;font-size:8px;color:var(--text-muted)')}>
      <span>${firstZoneLo}%</span>
      ${male ? '<span>20%</span>' : ''}
      <span>${lastZoneHi}%</span>
    </div>
