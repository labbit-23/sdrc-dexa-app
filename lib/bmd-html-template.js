...
<div class="page">
  ...
  <div class="card">
    ...
    <div class="row" ${s('gap:14px;align-items:flex-start')}>
      ...
      <div ${s(`width:1px;background:${P.border};align-self:stretch`)}></div>
      <div ${s('flex:1')}>
        <div ${s(`font-size:8px;font-weight:700;color:${P.gray};text-transform:uppercase;letter-spacing:.5px;margin-bottom:4px`)}>Daily Energy Needs</div>
        ...
        <div ${s(`font-size:8px;color:${P.gray};margin-top:4px;line-height:1.4`)}>RMR × activity level = daily maintenance calories.</div>
      </div>
    </div>
  </div>
