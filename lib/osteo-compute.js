...
export function computeOsteoData(raw, patientId, imageBaseUrl) {
  ...
  // Estimated body composition from MDB (GE Lunar AP Spine analysis)
  ...
  const compFatKg   = totalComp ? +(totalComp.fat_g  / 1000).toFixed(1) : null
  const compLeanKg  = totalComp ? +(totalComp.lean_g / 1000).toFixed(1) : null
