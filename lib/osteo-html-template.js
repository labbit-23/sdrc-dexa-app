...
function bmdTable(rows, P, suppressScores = false, hideYA = false, compact = false) {
  ...
  <div style="font-size:9px;color:${P.gray};margin-top:6px;line-height:1.5">
    <div>BMD: <span style="color:${C.greenLt}">■</span> &gt;0.9 · <span style="color:${C.amber}">■</span> 0.7–0.9 · <span style="color:${C.red}">■</span> &lt;0.7 g/cm²</div>
    ${suppressScores ? '' : `<div>T: <span style="color:${C.greenLt}">■</span> ≥−1.0 · <span style="color:${C.amber}">■</span> −1 to −2.5 · <span style="color:${C.red}">■</span> ≤−2.5</div>`}
  </div>`
}
...
function spineRefChart(age, bmd, gender, P) {
  ...
  // Match hip bmdRefChart total width (234px)
  const W = 230, H = 140
