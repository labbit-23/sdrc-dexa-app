...
<div class="page">
  ...
  <div class="col" ${st('flex:1;gap:12px;min-height:0')}>
    ...
    <div class="row" ${st('gap:14px;flex-shrink:0;align-items:flex-start')}>
      ...
      ${summary.left_implant ? '' : densitometryChart(pt.age, hipSiteToDisplay === 'total' ? lf.Total?.bmd ?? lf.Neck?.bmd ?? null : lf.Neck?.bmd ?? lf.Total?.bmd ?? null, 'hip', pt.gender, P)}
    ...
    <div class="row" ${st('gap:14px;flex-shrink:0;align-items:flex-start')}>
      ...
      ${summary.right_implant ? '' : densitometryChart(pt.age, hipSiteToDisplay === 'total' ? rf.Total?.bmd ?? rf.Neck?.bmd ?? null : rf.Neck?.bmd ?? rf.Total?.bmd ?? null, 'hip', pt.gender, P)}
