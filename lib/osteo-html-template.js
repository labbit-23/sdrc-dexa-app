...
function css(P, lh = false) {
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .page{width:210mm;height:252mm;padding:10mm 13mm;margin:0 auto;background:${P.bg};page-break-after:always;position:relative;display:flex;flex-direction:column;overflow:hidden}
