...
function spineRefChart(age, bmd, gender, P) {
  ...
  // Same width as hip bmdRefChart (W=230) for visual consistency
  const W = 230, H = 140
  ...
  <div ${st('flex-shrink:0;display:flex;flex-direction:column')}>
    ...
    <div ${st('margin-top:2px;font-size:6px;color:#999')}>
      <div ${st('display:flex;gap:6px;margin-bottom:1px')}>
        <span>● L1–L4</span>
        ...
        <span style="display:inline-flex;align-items:center;gap:2px"><svg width="10" height="3" style="display:block"><line x1="0" y1="1.5" x2="10" y2="1.5" stroke="#888" stroke-width="0.8" stroke-dasharray="4,3"/></svg>T-score</span>
      </div>
      <div ${st('display:flex;gap:6px')}>
...
function bmdRefChart(age, bmd, site, gender, P, dotLeft = null, dotRight = null) {
  ...
  <div ${st('flex-shrink:0')}>
    ...
    <div ${st('margin-top:3px;font-size:6.5px;color:#666')}>
      <div ${st('display:flex;gap:5px;margin-bottom:1px')}>
        ${twoSided
