...
.page{transform:scale(0.5);transform-origin:top left;margin-right:calc(-210mm * 0.5);margin-bottom:calc(-297mm * 0.5 + 16px);box-shadow:0 4px 20px rgba(0,0,0,.4);flex-shrink:0}
@media print{
