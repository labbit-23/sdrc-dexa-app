  ...
  <div class="col" ${st('flex:1;gap:10px;min-height:0;padding-bottom:28px;position:relative')}>
    ...
    <div class="row" ${st('gap:14px;flex:1;min-height:0;overflow:hidden')}>
      ...
      <div ${st('flex:1;display:flex;flex-direction:column;align-items:center;gap:4px;min-height:0')}>
        <div ${st('flex:1;min-height:0;width:100%;display:flex;align-items:center;justify-content:center;max-height:190px')}>
...
@media print{
  ...
  .page{height:${letterhead ? 'auto' : '297mm'}!important;transform:none!important;margin:0!important;box-shadow:none!important;page-break-after:always;display:flex}
  .page:last-child{page-break-after:auto}
}
</style></head><body>
${pagesHtml}
