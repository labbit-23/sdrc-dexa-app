...
<div class="page">
  ...
  <div class="col" ${st('flex:1;gap:10px;min-height:0;padding-bottom:28px;position:relative')}>
    ...
    <div ${st(`font-size:8.5px;color:${P.gray};margin-top:6px`)}>ISCD: Only Femoral Neck &amp; Total Hip used for WHO classification — Trochanter and Ward's are not diagnostic sites.</div>
    ${scanFootnotes([
