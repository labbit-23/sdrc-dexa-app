...
function compCard(comp, pt, P) {
  ...
  // Build item list — omit kg/FMI/LMI when only % estimates are available
  const items = [
  ...
  <div ${st(`background:${P.card};border:1px solid ${P.border};border-radius:8px;padding:12px 16px;margin-bottom:12px`)}>
    <div ${st(`font-size:12px;font-weight:700;color:${P.text};margin-bottom:4px`)}>Estimated Body Composition</div>
