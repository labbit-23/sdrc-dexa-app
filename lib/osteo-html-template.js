...
<div class="page">
  ...
  <div class="col" ${st('flex:1;gap:12px;min-height:0')}>
    ...
    <div class="row" ${st('gap:14px;flex-shrink:0;align-items:flex-start')}>
      ...
      ${summary.left_implant ? '' : bmdRefChart(pt.age, lf.Neck?.bmd ?? lf.Total?.bmd ?? null, 'hip', pt.gender, P)}
    ...
    <div class="row" ${st('gap:14px;flex-shrink:0;align-items:flex-start')}>
      ...
      ${summary.right_implant ? '' : bmdRefChart(pt.age, rf.Neck?.bmd ?? rf.Total?.bmd ?? null, 'hip', pt.gender, P)}
